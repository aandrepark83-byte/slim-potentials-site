...
export const generateMetadata = async (): Promise<Metadata | undefined> => {
  ...
  if (!process.env.BASEHUB_TOKEN) {
    return {
      title: "Changelog - Slim Potentials",
      description: "Product updates and improvements from Slim Potentials",
    };
  }
  ...
  try {
    ...
    console.warn("Failed to fetch changelog metadata from BaseHub:", error);
    return {
      title: "Changelog - Slim Potentials",
      description: "Product updates and improvements from Slim Potentials",
    };
...
export default async function ChangelogPage() {
    ...
    return (
      <div className="flex items-center justify-between border-b border-[--border] dark:border-[--dark-border]">
        <div className="mx-auto flex w-full max-w-screen-md flex-col items-start justify-between gap-4 border-r border-[--border] px-8 py-24 dark:border-[--dark-border] md:flex-row md:items-center">
          <Heading align="left" className="flex-1 !flex-col-reverse" subtitle="Stay updated with our latest improvements">
            <h1>Changelog</h1>
          </Heading>
          <div className="space-y-4">
            <p className="text-muted-foreground">
              Our changelog is currently being set up. Check back soon for updates on new features, improvements, and product releases.
            </p>
            <p className="text-muted-foreground">
  ...
  try {
    ...
    console.warn("Failed to load changelog content from BaseHub:", error);
    return (
      <div className="flex items-center justify-between border-b border-[--border] dark:border-[--dark-border]">
        <div className="mx-auto flex w-full max-w-screen-md flex-col items-start justify-between gap-4 border-r border-[--border] px-8 py-24 dark:border-[--dark-border] md:flex-row md:items-center">
          <Heading align="left" className="flex-1 !flex-col-reverse" subtitle="Stay updated with our latest improvements">
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground">
              We're experiencing technical difficulties loading our changelog content. Please try again later.
            </p>
            <p className="text-muted-foreground">
              In the meantime, explore our <a href="/#products" className="text-primary hover:underline">premium gummy supplements</a> designed to support your wellness journey.
            </p>
