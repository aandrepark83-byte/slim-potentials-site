...
export const generateStaticParams = async () => {
  try {
    if (!process.env.BASEHUB_TOKEN) {
      console.warn("BASEHUB_TOKEN not found, returning empty static params for changelog")
      return []
    }
    ...
    console.warn("Failed to generate static params from BaseHub for changelog:", error)
    return []
  }
}
...
export const generateMetadata = async ({ params: _params }: ChangelogPageParams): Promise<Metadata | undefined> => {
  try {
    ...
    console.warn("Failed to generate metadata from BaseHub for changelog:", error)
    return {
      title: "Changelog",
      description: "Changelog entry",
    }
...
export default async function ChangelogPage({ params: _params }: ChangelogPageParams) {
  try {
    ...
    console.warn("Failed to load changelog post from BaseHub:", error)
    return notFound()
  }
}
